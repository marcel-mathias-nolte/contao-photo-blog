...
class Tags extends Module
{
	...
	protected function compile()
    {
		...
		if($this->news4ward_tags_shuffle)
		{
			...
			if(!isset($_SESSION['news4wardTagsRandSeed']) || !$_SESSION['news4wardTagsRandSeed']) $_SESSION['news4wardTagsRandSeed'] = mt_rand();
			mt_srand($_SESSION['news4wardTagsRandSeed']);
			$order = array_map(function($val) { return mt_rand(); }, range(1, count($arrTags)));
