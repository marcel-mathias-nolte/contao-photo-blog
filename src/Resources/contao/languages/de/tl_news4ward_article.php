...
$GLOBALS['TL_LANG']['tl_news4ward_article']['tags']        = array('Tags','Zeichnen Sie den Artikel mit Schlagworten aus.');

$GLOBALS['TL_LANG']['tl_news4ward_article']['stati']                  = array('published'=>'veröffentlicht','review'=>'Review ausstehend','draft'=>'Entwurf');
$GLOBALS['TL_LANG']['tl_news4ward_article']['showGallery']            = array('Gallerie anzeigen', '');
...
$GLOBALS['TL_LANG']['tl_news4ward_article']['placeholder']            = array('Platzhalterbild', '');
/**
 * Legends
 */
