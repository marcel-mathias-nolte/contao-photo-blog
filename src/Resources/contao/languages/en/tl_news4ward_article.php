...
$GLOBALS['TL_LANG']['tl_news4ward_article']['category']    = array('Category', 'Here you can select entry category.');
...
$GLOBALS['TL_LANG']['tl_news4ward_article']['limit']                  = array('Limit the number of images', '');
