...
$GLOBALS['TL_LANG']['tl_news4ward']['categories']        = array('Categories', 'Here you can create/add new category.');
...
$GLOBALS['TL_LANG']['tl_news4ward']['categories_legend'] = 'Categories';
