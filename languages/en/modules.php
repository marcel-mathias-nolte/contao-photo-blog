...
$GLOBALS['TL_LANG']['FMD']['news4wardOrte']           = array('Location-Filter', 'Adds a list/filter of used locations to the page.');
$GLOBALS['TL_LANG']['FMD']['news4wardModels']         = array('Models-Filter', 'Adds a list/filter of used models to the page.');
$GLOBALS['TL_LANG']['FMD']['news4wardFotografen']     = array('Photographer-Filter', 'Adds a list/filter of used photographers to the page.');
